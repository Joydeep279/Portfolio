...
const WorkExpGlobe = () => {
    ...
    return (
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[95vw] sm:w-[90vw] h-[70vh] md:h-[80vh] flex justify-center items-end">
            ...
            <motion.button
                type="button"
                className="absolute bottom-[45%] md:bottom-[40%] left-[2%] sm:left-[10%] md:left-[20%] z-[60] h-12 sm:h-14 md:h-24 cursor-pointer bg-transparent border-none p-0"
            ...
            <motion.button
                type="button"
                className="absolute bottom-[45%] md:bottom-[40%] right-[2%] sm:right-[10%] md:right-[20%] z-[60] h-12 sm:h-14 md:h-24 cursor-pointer bg-transparent border-none p-0"
